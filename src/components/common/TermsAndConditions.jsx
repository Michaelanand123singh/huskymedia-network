      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
        <div className="p-8 sm:p-12">
          ...
          <div className="border-b border-gray-200 pb-6 mb-8">
            ...
            <p className="text-gray-700 mt-4">Please read these terms and conditions carefully before using Our Service.</p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <dl className="space-y-4">
                  ...
                  <div>
                    <dt className="font-semibold text-gray-900">Terms and Conditions</dt>
                    <dd className="text-gray-700 mt-1">(also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.termsfeed.com/terms-conditions-generator/" className="text-blue-600 hover:text-blue-800 underline" target="_blank" rel="noopener noreferrer">Terms and Conditions Generator</a>.</dd>
                  </div>
                  
                  <div>
                    <dt className="font-semibold text-gray-900">Third-party Social Media Service</dt>
                    <dd className="text-gray-700 mt-1">means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</dd>
                  </div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="font-medium">You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-6">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
            </section>

            {/* Final Sections */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Translation Interpretation</h2>
              <p className="text-gray-700">These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>
            </section>
            ...
            <section className="border-t border-gray-200 pt-8">
              ...
              <p className="text-gray-700 mb-6">If you have any questions about these Terms and Conditions, You can contact us:</p>
